...
internal Vec2F32
V2AddV2(Vec2F32 vec0, Vec2F32 vec1)
{
	Vec2F32 result;
...
internal Vec2F32
V2SubV2(Vec2F32 vec0, Vec2F32 vec1)
{
	Vec2F32 result;
...
internal Vec4F32
V4Lerp(Vec4F32 a, Vec4F32 b, F32 t)
{
	Vec4F32 result;
...
internal Mat4x4F32
Ortho(F32 left, F32 right, F32 bottom, F32 top, F32 _near, F32 _far)
{
	Mat4x4F32 result;
...
internal Mat4x4F32
M4MulM4(Mat4x4F32 a, Mat4x4F32 b)
{
	Mat4x4F32 result = {
...
internal Mat4x4F32
Translate(Mat4x4F32 mat, Vec3F32 trans)
{
...
internal Mat4x4F32
Scale(Mat4x4F32 mat, Vec3F32 scale)
{
	Mat4x4F32 result = M4(1.0f);
...
internal F32
DotVec2F32(Vec2F32 v0, Vec2F32 v1)
{
	F32 result;
...
internal F32
LengthVec2F32(Vec2F32 v)
{
	F32 result;

	result = SquareRootF32(Square(v.x) + Square(v.y));
...
GetClosestPointBetweenLineAndPoint(Vec2F32 p0, Vec2F32 p1, Vec2F32 p)
{
	...
	F32 t = DotVec2F32(to_mouse, line_dir) / DotVec2F32(line_dir, line_dir);

	Vec2F32 result = V2AddV2(p0, V2MulF32(line_dir, t));
